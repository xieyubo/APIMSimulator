...
internal class Expression
{
    ...
    public Expression(string body)
    {
        ...
        _compilation = Compile(className, body);
        _method = GenerateCode(_compilation).GetTypes().Single(t => t.Name == className).GetMethod("Execute")!;
    }

    public object? Execute(IContext context)
    {
        return _method.Invoke(null, new[] { context });
    }
